...
/**
 * Presentational header shared by the website admin and network admin shells.
 * Callers resolve their own page title.
 */
export const TopbarShell: FC<TopbarShellProps> = ({ title, onOpenSidebar }) => {
