...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'category', type: 'string', format: 'uuid', nullable: true),
        new OA\Property(property: 'sort', type: 'string', enum: ['created_at', 'updated_at', 'views'], nullable: true),
...
class IndexPostRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sort' => ['nullable', Rule::in(['created_at', 'updated_at', 'views'])],
